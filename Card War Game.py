...
class Hand:
    ...
    def __str__(self):
        return "Contains {} cards".format(len(self.cards))  #Qn. -> why returning length
...
class Player:
    ...
    def play_card(self):
        drawn_card = self.hand.remove_card()   #Qn -> how remove_card funcn. is being accessed without inheritance
